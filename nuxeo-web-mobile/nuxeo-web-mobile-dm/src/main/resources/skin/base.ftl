...
<head>
  ...
  <link rel="stylesheet" href="${skinPath}/css/jquery.mobile-1.3.0.min.css"/>
...
<#if Context.getProperty('Cordova')??>
  ...
  <script src="${skinPath}/script/jquery-1.9.1.min.js"></script>
  <script src="${skinPath}/script/jquery.mobile-1.3.0.min.js"></script>
